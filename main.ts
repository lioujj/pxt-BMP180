 ...
 * BMP180 block
 */
//% weight=100 color=#30b30c icon="\uf2dc" block="BMP180"
namespace BMP180 {
     ...
     * get measure value
     */
    //% blockId="getMeasureValue" block="BMP180 %myValue"
    //% weight=90 blockGap=8
    export function measureValue(myValue: valueType): number {
        let returnValue = 0;
        get();
        switch (myValue) {
            case 1:
            ...
            case 2:
                ...
                break;
            case 3:
                returnValue=Math.roundWithPrecision(44300 * (1 - Math.exp((1 / 5.256) * Math.log(P / 101325))), 2)
                break;
            default:
                returnValue = 0;
        }
